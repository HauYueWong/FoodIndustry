...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 26, 2022 at 02:43 PM
...
(1, 7385024096603511, 'admin', 'admin123@gmail.com', 'qwdqw', 'Malaysia', '213', 56000, 'admin', 123, 123, 123);
...
INSERT INTO `order_table` (`id`, `userid`, `name`, `quantity`, `total_price`) VALUES
(1, 7385024096603511, 'Banana Pancake (3pcs)', 1, 15),
(2, 7385024096603511, 'Banana Pancake (3pcs)', 12, 180);
...
(2, 64711255926, 'nightmare', '123'),
(3, 87407738206373538, 'admin', 'admin');
